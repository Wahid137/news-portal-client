                        ...
                        <>
                            {
                                user?.uid ?
                                    ...
                                    :
                                    <>
                                        <Button variant="outline-dark" className="me-2"><Link className="text-decoration-none" to="/login">Login</Link></Button>
                                        <Button variant="outline-dark"><Link to="/register">Register</Link></Button>
